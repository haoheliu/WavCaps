...
down_transform = Resample(orig_freq=48000, new_freq=32000)
...
cp = cp['model']
# del cp["text_encoder.text_encoder.embeddings.position_ids"]
...
esc50_test_dir = 'esc_test'
class_index_dict_path = 'ESC50_class_labels_indices_space.json'
